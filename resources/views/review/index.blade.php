    ...
    <div class="py-8">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-lg shadow p-6 mb-6">
                <h3 class="text-lg font-medium text-gray-900">오늘 복습할 카드</h3>
                <p class="text-sm text-gray-500 mt-1">{{ $cards->count() }}개의 카드가 복습 대기 중입니다.</p>
            </div>

            @if($cards->isEmpty())
                <div class="bg-white rounded-lg shadow p-12 text-center">
                    <div class="text-gray-400 text-lg">오늘 복습할 카드가 없습니다.</div>
                    <p class="text-sm text-gray-400 mt-2">학습을 계속하면 복습 카드가 자동으로 생성됩니다.</p>
                </div>
            @else
