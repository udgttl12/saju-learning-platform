                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('onboarding.store') }}" id="onboarding-form">
                        ...
                        <div id="step-1" class="space-y-4">
                            <h3 class="text-lg font-medium text-gray-900">1단계: 사주 경험</h3>
                            <p class="text-sm text-gray-500">사주/명리학에 대해 얼마나 알고 계신가요?</p>
                            ...
                            <div class="space-y-2">
                                <label class="flex items-center p-3 border rounded-lg cursor-pointer hover:bg-gray-50 transition">
                                    ...
                                    <div>
                                        <span class="font-medium">완전 초보</span>
                                        <p class="text-sm text-gray-500">사주가 무엇인지 잘 모릅니다</p>
                                    </div>
                                </label>
                                ...
                                <label class="flex items-center p-3 border rounded-lg cursor-pointer hover:bg-gray-50 transition">
                                    ...
                                    <div>
                                        <span class="font-medium">기초 지식 있음</span>
                                        <p class="text-sm text-gray-500">천간/지지 정도는 들어봤습니다</p>
                                    </div>
                                </label>
                                ...
                                <label class="flex items-center p-3 border rounded-lg cursor-pointer hover:bg-gray-50 transition">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500">오행, 십성 등 기본 개념을 알고 있습니다</p>
                                    </div>
                                </label>
                            </div>
                        ...
                        <div id="step-2" class="space-y-4 hidden">
                            <h3 class="text-lg font-medium text-gray-900">2단계: 한자 경험</h3>
                            <p class="text-sm text-gray-500">한자를 얼마나 읽을 수 있나요?</p>

                            <div class="space-y-2">
                                <label class="flex items-center p-3 border rounded-lg cursor-pointer hover:bg-gray-50 transition">
                                    <input type="radio" name="hanja_level" value="none" class="mr-3 text-indigo-600" {{ old('hanja_level') === 'none' ? 'checked' : '' }} required>
                                    <div>
                                        <span class="font-medium">전혀 모름</span>
                                        <p class="text-sm text-gray-500">한자를 거의 읽지 못합니다</p>
                                    </div>
                                </label>
                                ...
                                <label class="flex items-center p-3 border rounded-lg cursor-pointer hover:bg-gray-50 transition">
                                    ...
                                    <div>
                                        <span class="font-medium">기초</span>
                                        <p class="text-sm text-gray-500">간단한 한자는 읽을 수 있습니다</p>
                                    </div>
                                </label>
                                ...
                                <label class="flex items-center p-3 border rounded-lg cursor-pointer hover:bg-gray-50 transition">
                                    ...
                                    <div>
                                        <span class="font-medium">중급</span>
                                        <p class="text-sm text-gray-500">일반적인 한자를 읽을 수 있습니다</p>
                                    </div>
                                </label>
                                ...
                                <label class="flex items-center p-3 border rounded-lg cursor-pointer hover:bg-gray-50 transition">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500">한자에 익숙합니다</p>
                                    </div>
                                </label>
                            </div>
                            ...
                            <div class="flex justify-between pt-4">
                                <button type="button" onclick="showStep(1)" class="px-4 py-2 border border-gray-300 text-gray-700 rounded-md hover:bg-gray-50 transition">
                                    이전
                                </button>
                        ...
                        <div id="step-3" class="space-y-6 hidden">
                            <h3 class="text-lg font-medium text-gray-900">3단계: 학습 설정</h3>

                            <div class="space-y-2">
                                <label for="daily_goal_minutes" class="block font-medium text-gray-700">하루 학습 목표 (분)</label>
                            ...
                            <div class="space-y-2">
                                <p class="font-medium text-gray-700">선호하는 학습 방식</p>

                                <div class="grid grid-cols-2 gap-3">
                                    <label class="flex flex-col items-center p-4 border rounded-lg cursor-pointer hover:bg-gray-50 transition text-center">
                                        ...
                                        <span class="font-medium">시각적 학습</span>
                                        <span class="text-xs text-gray-500">도표, 그림 위주</span>
                                    </label>
                                    ...
                                    <label class="flex flex-col items-center p-4 border rounded-lg cursor-pointer hover:bg-gray-50 transition text-center">
                                        ...
                                        <span class="font-medium">읽기 학습</span>
                                        <span class="text-xs text-gray-500">텍스트 설명 위주</span>
                                    </label>
                                    ...
                                    <label class="flex flex-col items-center p-4 border rounded-lg cursor-pointer hover:bg-gray-50 transition text-center">
                                        ...
                                        <span class="font-medium">실습 학습</span>
                                        <span class="text-xs text-gray-500">퀴즈, 연습문제 위주</span>
                                    </label>
                                    ...
                                    <label class="flex flex-col items-center p-4 border rounded-lg cursor-pointer hover:bg-gray-50 transition text-center">
                                        ...
                                        <span class="font-medium">혼합형</span>
                                        <span class="text-xs text-gray-500">다양한 방식 조합</span>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="flex justify-between pt-4">
                                <button type="button" onclick="showStep(2)" class="px-4 py-2 border border-gray-300 text-gray-700 rounded-md hover:bg-gray-50 transition">
                                    이전
                                </button>
